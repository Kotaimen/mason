...
class TestRasterData(unittest.TestCase):
    ...
    def test_fromfile(self):
        filename = '/home/ray/Downloads/N30W100.hgt'
        ...
        aspect, slope = raster.aspect_and_slope(10, 111120)
        hillshade = raster.hillshade(aspect, slope, 270, 10)
        hillshade = (255 * hillshade).astype(numpy.ubyte)

        misc.imsave('/tmp/hillshade_270.png', hillshade)
